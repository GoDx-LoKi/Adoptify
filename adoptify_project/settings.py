"""
Django settings for adoptify_project project.
...
ALLOWED_HOSTS = ['adoptify.up.railway.app']
...
INSTALLED_APPS = [
    ...
    'pets',      # our pet listings app
    'shelters',  # our shelters app
    'accounts',
    'pages',
    'inquiries',
]
...
ROOT_URLCONF = 'adoptify_project.urls'
